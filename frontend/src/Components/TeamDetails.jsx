...
const TeamDetails = () => {
  ...
  return (
    <div className="sticky top-16 bg-white z-10" style={{ marginLeft: "30px", padding: '1rem', borderRadius: '8px' }}>
      <Header as='h1' attached='top' dividing textAlign='center' style={{ backgroundColor: "#f0f4f7", padding: '1rem', borderRadius: '8px 8px 0 0' }}>
      ...
      {isAdmin && (
        <Segment attached='bottom' clearing>
          <Button color='red' floated='left' onClick={handleConfirmDelete}>Delete Team</Button>
          <Button color='blue' floated='right' onClick={() => setEditModalOpen(true)}>Edit Team</Button>
        </Segment>
      )}
